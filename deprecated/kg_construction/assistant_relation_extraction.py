...
convo_history.insert(0, format_msg_oai("system", prompt_config['relation_extractor_intro']))

convo_history.insert(1, format_msg_oai("user", prompt_config['relations']))
convo_history.insert(2, format_msg_oai("user", prompt_config['entities']))
convo_history.insert(3, format_msg_oai("user", prompt_config['entities_subtypes']))
