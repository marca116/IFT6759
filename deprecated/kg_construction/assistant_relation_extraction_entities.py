...
convo_history.insert(0, format_msg_oai("system", prompt_config['entity_extractor_intro']))
...
prompt = prompt_config['entity_extractor_body'] + prompt_config['entity_extractor_json']
...
obj_result = extract_json_from_response("entity_extractor", result["content"])
print(obj_result)